...
const steps = [
  ...
  },
  {
    ...
    title: "Build",
    description:
      "We discuss the requirement with the referred client and work together to deliver the agreed services.",
  },
  {
    number: "04",
    title: "Earn",
    description:
      "Once the eligible work is completed and the final client payment is received, your referral commission becomes payable.",
  },
];
          ...
          <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            ...
            <div>
              ...
              <p className="mt-8 max-w-2xl text-lg leading-8 text-zinc-400">
                ...
                Introduce them to DOTEX.TALK and earn a referral commission
                when their eligible digital work is successfully completed
                and paid for.
            ...
            <div className="relative">
              ...
              <div className="border border-blue-500/20 bg-blue-500/5 p-8 sm:p-10">
                ...
                <p className="mt-3 text-zinc-400">
                  of the total eligible work amount
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 lg:py-32">
          ...
          <div className="mb-16 grid gap-8 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <p className="max-w-2xl text-lg leading-8 text-zinc-400">
              ...
              project, and receive your commission after the eligible work is
              completed and the final payment has been received.
            </p>
          ...
          <div className="grid gap-16 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-7 max-w-xl text-lg leading-8 text-zinc-400">
                If a referred client purchases multiple eligible services,
                their eligible work is combined when calculating the referral
                commission.
              </p>
              ...
              <div className="p-7">
                ...
                <div className="mt-7 border-t border-white/10 pt-6">
                  ...
                  <p className="mt-5 text-xs leading-6 text-zinc-600">
                    Commission = 5% of total eligible work actually received,
                    subject to the ₹5,000 maximum.
                  </p>
            ...
            <div className="mt-12 space-y-0 border-t border-white/10">
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  The combined eligible work for a referred client must have
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  The commission is 5% of the total eligible work amount
                  actually received from the referred client, subject to a
                  maximum of ₹5,000 per referred client.
                </p>
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  Multiple eligible services purchased by the same referred
                  client may be combined when calculating the commission.
                </p>
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  The referral must be registered before the prospective
                  client has already contacted DOTEX.TALK regarding the same
                  requirement. The first valid registered referral will
                  normally receive referral credit.
                </p>
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  Commission becomes payable only after the eligible work is
                  completed and the final payment has been received from the
                  client.
                </p>
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  Eligible work must be purchased within 12 months from the
                  date the referral is registered.
                </p>
              ...
              <div className="grid gap-4 border-b border-white/10 py-7 md:grid-cols-[220px_1fr]">
                ...
                <p className="leading-7 text-zinc-500">
                  No commission is payable on cancelled, refunded or unpaid
                  work.
                </p>
...
<div className="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
  ...
  <Link
    href="/terms#referral"
    className="inline-flex items-center gap-2 text-sm font-semibold text-zinc-400 transition hover:text-blue-500"
  >
            ...
            <div className="relative grid gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-center">
              ...
              <div>
                ...
                <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-400">
                  Send us the details of someone who may benefit from our
                  services. We&apos;ll take it from there.
                </p>
              ...
              <div className="border border-white/10 bg-black p-7">
                ...
                <p className="mt-3 text-sm leading-6 text-zinc-500">
                  Contact us with the referral details and we&apos;ll register
                  the referral before moving forward.
                </p>
                ...
                <p className="mt-4 text-center text-xs leading-5 text-zinc-600">
                  Referral details should be submitted before the prospective
                  client contacts DOTEX.TALK about the same requirement.
                </p>
