        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-36 lg:px-8 lg:pb-32 lg:pt-44">
          ...
          <div className="max-w-5xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-zinc-400">
              ...
              Have a website, digital project or business idea in mind?
              Tell me what you are working on and let&apos;s explore how
              DOTEX.TALK can help.
          ...
          <div className="grid gap-16 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div>
              ...
              <p className="mt-7 max-w-md text-lg leading-8 text-zinc-400">
                ...
                Share what you need, and we can work through the details
                together.
            ...
            <div className="border border-white/10 bg-zinc-950 p-7 sm:p-10">
              ...
              <div>
                ...
                <p className="mt-4 text-sm leading-7 text-zinc-500">
                  ...
                  The easiest way to get started is to send your project
                  details through WhatsApp or email.
              ...
              <div className="mt-10 border-t border-white/10 pt-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-blue-500 px-6 py-4 text-sm font-semibold text-white transition hover:bg-blue-400"
                >
                ...
                <a
                  href="mailto:info@dtextalk.com"
                  className="mt-3 inline-flex w-full items-center justify-center gap-3 rounded-full border border-white/10 px-6 py-4 text-sm font-semibold text-zinc-300 transition hover:border-white/20 hover:text-white"
                >
              ...
              <p className="mt-6 text-center text-xs leading-5 text-zinc-600">
                ...
                <Link
                  href="/privacy"
                  className="text-zinc-500 underline underline-offset-4 transition hover:text-blue-500"
                >
                  Privacy Policy
                </Link>
      ...
      <section className="border-t border-white/10">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            ...
            <Link
              href="/referral"
              className="inline-flex w-fit shrink-0 items-center gap-2 rounded-full border border-white/10 px-6 py-3.5 text-sm font-semibold transition hover:border-blue-500/50 hover:text-blue-500"
            >
              Refer &amp; Earn
              <ArrowUpRight size={17} />
            </Link>
