        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-4">
              <Link href="/referral" className="inline-flex items-center gap-2 text-sm font-semibold text-zinc-300 transition hover:text-blue-500">
                Refer a project <ArrowUpRight size={16} />
              </Link>
              <a href="https://wa.me/918157813455" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-zinc-300 transition hover:text-green-400">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {socialLinks.map(({ label, href }) => (
                <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label} className="inline-flex h-10 items-center justify-center rounded-full border border-white/10 px-4 text-xs font-semibold text-zinc-500 transition hover:border-blue-500/50 hover:text-white">
                  {label}
                </a>
              ))}
              <a href="https://www.trustpilot.com/review/dotextalk.com" target="_blank" rel="noopener noreferrer" className="inline-flex h-10 items-center justify-center rounded-full border border-white/10 px-4 text-xs font-semibold text-zinc-500 transition hover:border-blue-500/50 hover:text-white">
                Trustpilot
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-4">
              <a href="mailto:info@dotextalk.com" className="inline-flex w-fit items-center gap-2 text-sm text-zinc-500 transition hover:text-white">
                <Mail size={16} /> info@dotextalk.com
              </a>
              <a href="https://wa.me/918157813455" target="_blank" rel="noopener noreferrer" className="inline-flex w-fit items-center gap-2 text-sm text-zinc-500 transition hover:text-white">
                <MessageCircle size={16} /> +91 81578 14355
              </a>
            </div>
          </div>
